...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--maskroot', help='path to images (should have subfolders makeup, non-makeup)')
        parser.add_argument('--batch_size', type=int, default=1, help='input batch size')
        parser.add_argument('--loadSize', type=int, default=361, help='scale images to this size')
        parser.add_argument('--fineSize', type=int, default=360, help='then crop to this size')
        ...
        parser.add_argument('--netG', type=str, default='beautyGAN', help='selects model to use for netG')
